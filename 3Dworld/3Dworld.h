...
namespace world
{
  ...
  */
  ...
  public:
    ...
    std::vector<tri> triworld = {{{{100, 50, 50}, {0, 50, 50}, {100, 100, 50}}, {0, 255, 0}, {100, 50, 0}}};
    ...
    void drawtri(const tri &rti, SkCanvas *window){
      ...
      for(int i =0; i < 3; i++){
        SkScalar x = rti.tri[i].x;
        SkScalar y = rti.tri[i].y;
      ...
      SkPaint p;
      p.setAntiAlias(true);
      p.setARGB(255,rti.col.r, rti.col.g, rti.col.b);
